  ...
  const categories = [
    {
      ...
      title: 'Child Plans',
      count: '4 Plans',
      tag: 'Education & Milestones',
      description: 'Guaranteed higher education corpus & milestone funds (Amritbaal, Jeevan Tarun).',
    ...
    },
    {
      ...
      count: '8 Plans',
      tag: 'Pure Family Protection',
      description: 'High-value pure risk life assurance with online discounts (Digi Term, Yuva Term).',
    ...
    },
    {
      ...
      count: '5 Plans',
      tag: 'Lifelong Retirement',
      description: 'Immediate & deferred annuities with guaranteed lifelong cashflow (Saral Pension, Jeevan Shanti).',
    ...
    },
    {
      ...
      count: '9 Plans',
      tag: 'Disciplined Savings',
      description: 'Participating life assurance combining family protection with lump-sum bonus payouts.',
      accent: 'border-emerald-200 bg-emerald-50/70 text-emerald-950',
      badgeClass: 'bg-emerald-100 text-emerald-800'
    },
    {
      id: 'whole-life',
      title: 'Protection & Whole Life',
      count: '2 Plans',
      tag: 'Lifelong 8-10% Income',
      description: 'Lifelong income benefits and complete family security up to age 100 (Jeevan Umang, Jeevan Utsav).',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <div className="max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-50 text-amber-900 border border-amber-200 text-xs font-mono font-bold uppercase tracking-wider mb-3.5 shadow-2xs">
              ...
              <span>Official LIC Integration • IRDAI Reg. 512</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-sanchay-navy-700 font-normal mt-2 leading-relaxed">
              Explore verified LIC insurance, pension, protection, child and investment plans.
            </p>
            ...
            <div className="flex items-center gap-2 sm:gap-4 mt-4 pt-4 border-t border-slate-100 flex-wrap text-xs font-mono font-bold">
              <span className="text-slate-400 uppercase tracking-wider">SANCHAY SOURCING PILLARS:</span>
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-[#FAFAFC] border border-slate-200/90 shadow-2xs">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6 pb-4 border-b border-slate-200/80">
            ...
            >
              <span>See all 38 verified plans</span>
              ...
              >
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 p-2.5 rounded-xl bg-slate-50 border border-slate-100 text-[11px] mb-3">
                    <div>
                      <span className="text-[9px] font-mono text-slate-400 font-bold uppercase block">Entry Age</span>
                      <span className="font-bold text-sanchay-navy-950">{plan.entry_age}</span>
                    </div>
                    <div>
                      <span className="text-[9px] font-mono text-slate-400 font-bold uppercase block">Min Cover</span>
